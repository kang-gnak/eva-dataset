...
##EVA_category.zip and EVA_together.zip

This file contains all the resized images we selected from AVA dataset.

You can use our classification of content with EVA_category.zip or use your own classification on EVA_together.zip.
